...
in C++ success order. A process-wide pre-ConnectTo character claim rejects a second live session
for the same GUID, preserving C++'s single `Player*` save authority; ordinary pending spell/skill
