...
- [x] **Issue #161 — battle-pet trainer purchases no longer strand the charge across the
  ...
  (whose Login DB transaction writes pet + receipt together under the account fence), records
  completion before publishing, and refunds terminal failures exactly once; login recovery
