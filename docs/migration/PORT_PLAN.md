...
`0f79ca837a7417876986cf1803f715a8512b7503` (PR #883, following #876/#873/#871/#869/#866/#864/#862/#860/#859/#855/#854/#853 and #851; the earlier `179fd5d4`, `93fa95a9`, `6f42782f`, `995cd77f`, `cc055998`, `4e3ad8f0`, `1143ed41`, `a9623787`, `276e3981`, `d934451a`, `7bb9a911`, `16303cc7`, `62c1369f`, `db125076`, `a3e97063`, `a96ee548`, `76a05081`,
`886e13ad`,
...
The next bounded P2 owner closure moves represented guild membership and invitation
...
`SetGuildIdInvited` and `SetGuildRank` (`Player.h:1939,1943`); the old composite
guild install is retired. Session retains GuildMgr/cache, protocol and application
effects, while its broad whole-state guild mutator remains fixture-only under
`cfg(test)`. Owner, social-scenario, guild-handler, package, architecture and
formatting/diff checks pass. The delivery does not claim guild-manager/database
durability, captures or live QA, and the next #584 macro still requires a fresh C0-C4
audit after this candidate.
