...
- Bugs corregidos: 27 (`#CSharpAudit.COMPRESS.1`, `#CSharpAudit.BNETREST.1`, `#CSharpAudit.BNETREST.2`, `#CSharpAudit.BNETREST.3`, `#CSharpAudit.BNETREST.4`, `#CSharpAudit.FEATURE.1`, `#CSharpAudit.BNETSRP.1`, `#CSharpAudit.BNETSRP.2`, `#CSharpAudit.BNETSRP.3`, `#CSharpAudit.BNETSRP.4`, `#CSharpAudit.MOVEMENT.1`, `#CSharpAudit.SPELL.1`, `#CSharpAudit.COMBAT.1`, `#CSharpAudit.CHAT.1`, `#CSharpAudit.CHAT.2`, `#CSharpAudit.ITEM.1`, `#CSharpAudit.PARTY.3`, `#CSharpAudit.PARTY.1`, `#CSharpAudit.PARTY.2`, `#CSharpAudit.PARTY.4`, `#CSharpAudit.MISC.1`, `#CSharpAudit.MISC.2`, `#CSharpAudit.LOOT.1`, `#CSharpAudit.QUESTXP.1`, `#CSharpAudit.QUESTXP.2`, `#CSharpAudit.CEMETERY.1`, `#CSharpAudit.QUESTCMSG.1`).
...
- [x] `#CSharpAudit.PARTY.2` - Corregido; `HandlePartyInviteOpcode` usa knobs C++ `GM.AllowInvite`, `AllowTwoSide.Interaction.Group` y `PartyLevelReq`, y aplica social `HasIgnore`/`HasFriend` del target antes del lookup de grupo como C++. Anclas: `GroupHandler.cpp:58-184`, `SocialMgr.cpp:184-191`, `World.cpp:790,913,1163`, `SharedDefines.h:6787-6803`. Tests: `party_invite_configs_use_cpp_world_config_keys`, `party_invite_allows_gm_target_when_cpp_config_enabled`, `party_invite_allows_cross_faction_when_cpp_config_enabled`, `party_invite_rejects_low_level_non_friend_like_cpp`, `party_invite_social_matching_covers_guid_account_and_friend_like_cpp`.
...
- [ ] `#CSharpAudit.ITEM.2` - Parcial: corregidos gates C++ de `InvUpdate` para `SwapInvItem`/`SwapItem`/`AutoEquipItem`/`AutoStoreBagItem`; pendientes `IsValidPos`, bank access, contenedores/nested bags, `CanEquipItem`/`CanStoreItem`/`CanUnequipItem`, `DestroyItem` container-aware y `Player::SwapItem` completo.
