...
685 exact AST rows with multiplicity 705. The workspace-wide persistence inventory contains 19,136
exact rows—9,955 production and 9,181 test-fixture—with multiplicity 20,948 (11,129 production and
9,819 test). Six generated-source inputs are an orthogonal subset, not a third source class. Schema
...
database opening, advisory locks, value flow and escapes. The 897 semantic groups classify every
