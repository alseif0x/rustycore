...
685 exact AST rows with multiplicity 705. The workspace-wide persistence inventory contains 7,806
exact rows—5,470 production and 2,336 test-fixture—with multiplicity 8,776 (6,407 production and
2,369 test). Three generated-source inputs are an orthogonal subset, not a third source class. Schema
