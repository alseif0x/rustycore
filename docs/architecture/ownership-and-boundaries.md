...
685 exact AST rows with multiplicity 705. The workspace-wide persistence inventory contains 23,505
exact rows—12,978 production and 10,527 test-fixture—with multiplicity 25,743 (14,490 production and
11,253 test). Six generated-source inputs are an orthogonal subset, not a third source class. Schema
