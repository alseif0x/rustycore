...
The current integration head is `1143ed416c41af1219f8c76cb35e85f35c4e8f97` (PR #832).
...
projection and fail-closed Combat config validation through the same boundary. Complete
