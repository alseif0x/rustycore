...
The current integration head is `a9623787fea086f0a1350d2b05d6ec5a300432e4` (PR #830).
...
projection and fail-closed Generic config validation through that boundary. Complete
