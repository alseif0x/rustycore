//! Core C++ `Condition::Meets` and grouped ConditionMgr evaluation.

use num_traits::FromPrimitive;
use wow_constants::{
    ConditionInstanceInfo, ConditionSourceType, ConditionType, MAX_CONDITION_TARGETS, RelationType,
    TypeId, TypeMask,
};
use wow_data::{
    Condition, ConditionEntriesByTypeStore, ConditionId, is_player_meeting_condition_like_cpp,
};

use crate::context::{
    ConditionMapRef, ConditionMapStateSnapshot, ConditionMeetResult, ConditionSourceInfo,
    QUEST_STATUS_COMPLETE_LIKE_CPP, QUEST_STATUS_FAILED_LIKE_CPP, QUEST_STATUS_INCOMPLETE_LIKE_CPP,
    QUEST_STATUS_NONE_LIKE_CPP, QUEST_STATUS_REWARDED_LIKE_CPP, compare_values_f32_like_cpp,
    compare_values_u64_like_cpp, is_player_object_like_cpp, is_unit_object_like_cpp,
    unit_stand_state_is_sit_like_cpp, unit_stand_state_is_stand_like_cpp,
};
