...
use wow_constants::{
    ComparisonType, ConditionInstanceInfo, MAX_CONDITION_TARGETS, TypeId, TypeMask,
    UnitStandStateType,
};
use wow_data::{Condition, PlayerConditionContextLikeCpp, PlayerConditionStore};
...
impl ConditionPlayerQuestSnapshot<'_> {
    pub(crate) fn quest_status_like_cpp(self, quest_id: u32) -> u8 {
        self.statuses
            .iter()
    ...
    pub(crate) fn is_quest_rewarded_like_cpp(self, quest_id: u32) -> bool {
        self.rewarded_quest_ids.contains(&quest_id)
    }

    pub(crate) fn is_daily_quest_done_like_cpp(self, quest_id: u32) -> bool {
        self.daily_quest_ids.contains(&quest_id)
    }

    pub(crate) fn quest_is_in_log_like_cpp(self, quest_id: u32) -> bool {
        !matches!(
...
impl ConditionPlayerProgressionSnapshot<'_> {
    pub(crate) fn has_item_count_like_cpp(
        self,
        item_id: u32,
        required_count: u32,
        check_bank: bool,
    ...
    pub(crate) fn has_item_or_gem_equipped_like_cpp(self, item_id: u32) -> bool {
        self.equipped_item_or_gem_ids.contains(&item_id)
    }

    pub(crate) fn has_skill_base_value_like_cpp(self, skill_id: u32, required_value: u32) -> bool {
        self.skills
            .iter()
    ...
    pub(crate) fn has_spell_like_cpp(self, spell_id: u32) -> bool {
        self.spell_ids.contains(&spell_id)
    }

    pub(crate) fn has_achievement_like_cpp(self, achievement_id: u32) -> bool {
        self.achievement_ids.contains(&achievement_id)
    }

    pub(crate) fn has_reputation_rank_like_cpp(self, faction_id: u32, rank_mask: u32) -> bool {
        self.reputations
            .iter()
    ...
    pub(crate) fn has_title_like_cpp(self, title_id: u32) -> bool {
        self.title_ids.contains(&title_id)
    }

    pub(crate) fn battle_pet_count_like_cpp(self, species_id: u32) -> u32 {
    ...
    pub(crate) fn has_active_scene_like_cpp(self, scene_id: u32) -> bool {
...
impl ConditionMapStateSnapshot<'_> {
    pub(crate) fn world_state_value_like_cpp(self, world_state_id: u32) -> i32 {
        self.world_states
            .iter()
    ...
    pub(crate) fn instance_data_value_like_cpp(
        self,
...
pub(crate) fn compare_values_u64_like_cpp(comparison_type: u32, left: u64, right: u64) -> bool {
...
pub(crate) fn compare_values_f32_like_cpp(comparison_type: u32, left: f32, right: f32) -> bool {
    match ComparisonType::from_u32(comparison_type) {
        Some(ComparisonType::Eq) => left == right,
        Some(ComparisonType::High) => left > right,
        Some(ComparisonType::Low) => left < right,
...
pub(crate) fn is_player_object_like_cpp(object: &WorldObject) -> bool {
    matches!(
...
pub(crate) fn is_unit_object_like_cpp(object: &WorldObject) -> bool {
    matches!(
        object.object().type_id(),
...
pub(crate) fn unit_stand_state_is_sit_like_cpp(stand_state: u32) -> bool {
...
pub(crate) fn unit_stand_state_is_stand_like_cpp(stand_state: u32) -> bool {
