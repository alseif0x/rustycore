...
impl UpdateObject {
    ...
    pub fn create_player_with_party_type(
        ...
        let create_data = PlayerCreateData {
            ...
            attack_power_multiplier: combat.attack_power_multiplier,
            ranged_attack_power: combat.ranged_attack_power,
            ranged_attack_power_mod_pos: combat.ranged_attack_power_mod_pos,
            ranged_attack_power_multiplier: combat.ranged_attack_power_multiplier,
            ...
            mod_damage_done_pos: combat.mod_damage_done_pos,
