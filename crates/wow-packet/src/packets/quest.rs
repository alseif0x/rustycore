...
#[cfg(test)]
#[path = "quest/adventure_map_start_quest_tests.rs"]
mod adventure_map_start_quest_tests;

#[cfg(test)]
#[path = "quest/quest_confirm_accept_tests.rs"]
mod quest_confirm_accept_tests;

#[cfg(test)]
#[path = "quest/push_quest_to_party_tests.rs"]
mod push_quest_to_party_tests;

#[cfg(test)]
#[path = "quest/quest_push_result_tests.rs"]
mod quest_push_result_tests;

#[cfg(test)]
#[path = "quest/quest_giver_quest_complete_tests.rs"]
