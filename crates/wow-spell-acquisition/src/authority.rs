...
pub struct SpellAcquisitionCraftValidityAuthorityLikeCpp {
...
impl SpellAcquisitionCraftValidityAuthorityLikeCpp {
    pub fn from_audited_rows_like_cpp(
...
#[derive(Debug, Clone, Default, PartialEq, Eq)]
pub struct SpellAcquisitionCastAuthorityLikeCpp {
