//! Shared acquisition fixtures; absent from default production builds.
...
pub struct SpellAcquisitionPlanFixtureLikeCpp {
...
impl SpellAcquisitionPlanFixtureLikeCpp {
    pub fn build(self) -> SpellAcquisitionPlanLikeCpp {
        SpellAcquisitionPlanLikeCpp {
            ...
            profession_association_inputs: self.profession_association_inputs,
...
pub struct FixtureInput {
    ...
    pub effects: Vec<SpellAcquisitionEffectLikeCpp>,
    pub dependencies: Vec<SpellAcquisitionDependencyLikeCpp>,
    pub dependency_nodes: Vec<(u32, SpellLearnSpellNodeLikeCpp)>,
    pub required_edges: Vec<(u32, u32)>,
    pub chains: Vec<(u32, SpellChainNodeLikeCpp)>,
    pub learn_skills: Vec<(u32, SpellLearnSkillNodeLikeCpp)>,
    pub cast_safe_spell_ids: Vec<u32>,
    pub misc_rows: Vec<SpellAcquisitionMiscLikeCpp>,
    pub level_rows: Vec<SpellAcquisitionLevelsLikeCpp>,
    pub skill_lines: Vec<SkillLineEntry>,
    pub incomplete_skill_line_ids: Vec<u32>,
    pub skill_abilities: Vec<SkillLineAbilityRecord>,
    pub skill_race_class: Vec<SkillRaceClassInfoRecord>,
    pub skill_tiers: Vec<SkillTiersRowLikeCpp>,
}

pub struct MetadataFixture {
    pub catalog: SpellAcquisitionCatalogLikeCpp,
    pub spell_chains: SpellChainStoreLikeCpp,
    pub spell_learn_skills: SpellLearnSkillStoreLikeCpp,
    pub spell_learn_spells: SpellLearnSpellStoreLikeCpp,
    pub spell_required: SpellRequiredStoreLikeCpp,
    pub spell_custom_attributes: SpellCustomAttributeStoreLikeCpp,
    pub trait_definitions: TraitDefinitionStore,
    pub cast_authority: SpellAcquisitionCastAuthorityLikeCpp,
    pub craft_validity_authority: SpellAcquisitionCraftValidityAuthorityLikeCpp,
    pub mounts: MountStore,
    pub mounts_complete: bool,
    pub skills: SkillStore,
    pub skill_lines: SkillLineStore,
    pub skill_tiers: SkillTiersStoreLikeCpp,
}

impl MetadataFixture {
    pub fn new(mut input: FixtureInput) -> Self {
    ...
    pub fn metadata(&self) -> SpellAcquisitionMetadataLikeCpp<'_> {
...
pub fn snapshot() -> PlayerSpellAcquisitionSnapshotLikeCpp {
...
pub fn spell_row(spell_id: u32, active: bool, dependent: bool) -> PlayerSpellAcquisitionRowLikeCpp {
...
pub fn deleted_skill_row(skill_id: u32) -> PlayerSkillAcquisitionRowLikeCpp {
...
pub fn skill_line(skill_id: u32, parent: u32, parent_tier: i32) -> SkillLineEntry {
...
pub fn skill_line_with_category(
    skill_id: u32,
    category_id: i8,
    parent: u32,
    parent_tier: i32,
...
pub fn race_class(skill_id: u16, record_id: u32, tier_id: i16) -> SkillRaceClassInfoRecord {
...
pub fn tiers(tier_id: u32) -> SkillTiersRowLikeCpp {
...
pub fn levels(spell_id: u32, base_level: i64, spell_level: i64) -> SpellAcquisitionLevelsLikeCpp {
...
pub fn cast_evidence(spell_id: u32) -> SpellAcquisitionCastAuditEvidenceLikeCpp {
...
pub fn deterministic(outcome: SpellAcquisitionOutcomeLikeCpp) -> SpellAcquisitionPlanLikeCpp {
    match outcome {
