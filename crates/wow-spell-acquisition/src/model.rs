...
pub enum SpellAcquisitionRootLikeCpp {
    DirectLearn(u32),
    TrainerWrapperCast(u32),
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum PlayerSpellPersistenceStateLikeCpp {
    Unchanged,
    Changed,
    New,
    Removed,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct PlayerSpellAcquisitionRowLikeCpp {
    pub spell_id: u32,
    pub active: bool,
    pub disabled: bool,
    pub dependent: bool,
...
pub enum ProfessionAssociationInputLikeCpp {
    Unassigned,
    Slot(u8),
    Invalid(i8),
}
...
impl ProfessionAssociationInputLikeCpp {
    pub const fn from_database_value_like_cpp(value: i8) -> Self {
        match value {
            -1 => Self::Unassigned,
    ...
    pub const fn database_value_like_cpp(self) -> i8 {
        match self {
            Self::Unassigned => -1,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum PlayerSkillPersistenceStateLikeCpp {
    Unchanged,
    Changed,
    New,
    Deleted,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct PlayerSkillAcquisitionRowLikeCpp {
    pub skill_id: u32,
    pub step: u16,
    pub value: u16,
    pub maximum: u16,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum PlayerAcquisitionLifecycleLikeCpp {
    Loading,
    OutOfWorld,
    InWorld,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct PlayerExecutedDualWieldEffectLikeCpp {
    pub effect_record_id: u32,
    pub effect_index: u8,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct PlayerCastAcquisitionResolutionLikeCpp {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct PlayerFuturePlayerConditionResolutionLikeCpp {
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub enum SpellAcquisitionProvenanceLikeCpp {
    Root {
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct PlannedSpellTransitionLikeCpp {
    pub spell_id: u32,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct PlannedSkillTransitionLikeCpp {
    pub skill_id: u32,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct PlannedOverrideTransitionLikeCpp {
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub enum PlannedAcquisitionMutationLikeCpp {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum PlannedAcquisitionCastReasonLikeCpp {
    TalentLearnEffect,
    PassiveLearn,
    SkillStep,
    CastWhenLearned,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub enum SpellAcquisitionPostCommitActionLikeCpp {
    LearnedSpell {
        spell_id: u32,
        favorite: bool,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub enum SpellAcquisitionDiagnosticLikeCpp {
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct SpellAcquisitionPlanLikeCpp {
    ...
    // This field is deliberately confined to the planner crate.
    // World callers may tailor ordinary post-commit consumers, but must not be
    // able to replace both those actions and their planner-owned authority
    // tape with matching fabricated values. The world application only reads
    // it through an immutable accessor; `planner` is its sole production writer.
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub enum SpellAcquisitionPublicationRequirementLikeCpp {
    LearnedSpell {
        spell_id: u32,
        favorite: bool,
        suppress_messaging: bool,
...
impl SpellAcquisitionPlanLikeCpp {
    /// Read the planner-owned causal tape without permitting its replacement.
    /// World application adapters compare this against the action projection.
    ///
    /// ```compile_fail
    /// use wow_spell_acquisition::SpellAcquisitionPlanLikeCpp;
    /// fn replace_authority(plan: &mut SpellAcquisitionPlanLikeCpp) {
    ///     plan.publication_requirements.clear();
    /// }
    /// ```
    pub fn publication_requirements_like_cpp(
        &self,
    ) -> &[SpellAcquisitionPublicationRequirementLikeCpp] {
...
impl SpellAcquisitionPlanLikeCpp {
    /// Fault injection only; this method is absent from default production builds.
    pub fn publication_requirements_for_test_like_cpp(
        &mut self,
    ) -> &mut Vec<SpellAcquisitionPublicationRequirementLikeCpp> {
        &mut self.publication_requirements
    }
    ...
    pub fn no_publications_for_test_like_cpp(
        root: SpellAcquisitionRootLikeCpp,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub enum SpellAcquisitionIndeterminateLikeCpp {
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub enum SpellAcquisitionOutcomeLikeCpp {
    Deterministic(SpellAcquisitionPlanLikeCpp),
    Indeterminate(SpellAcquisitionIndeterminateLikeCpp),
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub enum SpellAcquisitionSnapshotAdapterErrorLikeCpp {
    IncompleteSpellRows,
    IncompleteSkillRows,
...
pub enum SpellAcquisitionCastIndeterminateReasonLikeCpp {
    ScriptBinding,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct SpellAcquisitionCastAuditEvidenceLikeCpp {
    pub spell_id: u32,
...
#[derive(Debug, Clone, PartialEq, Eq, PartialOrd, Ord)]
pub enum SpellAcquisitionCraftValidityIndeterminateReasonLikeCpp {
