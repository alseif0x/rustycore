...
pub use unit::{
    ...
    UNIT_DATA_CLASS_ID_BIT, UNIT_DATA_COMBAT_REACH_BIT, UNIT_DATA_CRITTER_BIT,
    UNIT_DATA_DISPLAY_ID_BIT, UNIT_DATA_DISPLAY_POWER_BIT, UNIT_DATA_DISPLAY_SCALE_BIT,
    UNIT_DATA_EMOTE_STATE_BIT, UNIT_DATA_FACTION_TEMPLATE_BIT, UNIT_DATA_FLAGS_BIT,
    UNIT_DATA_FLAGS2_BIT, UNIT_DATA_FLAGS3_BIT, UNIT_DATA_HEALTH_BIT, UNIT_DATA_HOVER_HEIGHT_BIT,
    UNIT_DATA_LEVEL_BIT, UNIT_DATA_MAX_HEALTH_BIT, UNIT_DATA_MAX_POWER_FIRST_BIT,
    UNIT_DATA_MODS_PARENT_BIT, UNIT_DATA_NATIVE_DISPLAY_ID_BIT, UNIT_DATA_NATIVE_DISPLAY_SCALE_BIT,
